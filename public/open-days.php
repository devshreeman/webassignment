...
$events = [
    ...
    ['date'=>'22 November 2026', 'weekday'=>'Sunday',    'time'=>'11:00 – 15:00', 'type'=>'Applicant Visit Day',       'desc'=>'Exclusive event for students who have received an offer from the University of Liverpool. Includes department-specific sessions and campus tours.'],
];
?>
...
<section style="background:linear-gradient(135deg,var(--color-primary-dark) 0%,var(--color-primary) 100%);padding:var(--space-12) 0;color:#fff;text-align:center;">
  <div class="container">
    ...
    <p style="color:rgba(255,255,255,0.7);max-width:520px;margin:0 auto;font-size:1.05rem;">Visit our campus, meet our academic staff, and explore life at the University of Liverpool.</p>
  </div>
</section>
