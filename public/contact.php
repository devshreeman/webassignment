...
// Contact detail rows — SVG icon path, label, value
$contactDetails = [
    [
        ...
        'label' => 'Address',
        'value' => 'University of Excellence<br>1 Academic Way<br>Excellence City, EC1 2UE<br>United Kingdom',
        'raw'   => true,
    ],
    [
    ...
    [
        ...
        'value' => 'studentservices@excellence.ac.uk',
    ],
    [
