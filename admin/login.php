...
<head>
  ...
  <title>Admin Login | University of Excellence</title>
...
<div class="auth-page" role="main">
  <div class="auth-card">
    ...
    <div class="auth-card__logo">
      <div class="auth-card__logo-mark" aria-hidden="true">UE</div>
      <div>
        <div style="font-family:'Merriweather',serif;font-size:0.95rem;font-weight:700;color:var(--color-primary);">University of Excellence</div>
